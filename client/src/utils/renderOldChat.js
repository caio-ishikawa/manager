        ...
        return(
            ...
            <Grid key={idx} container justify="center" spacing={-26}>
                <Grid sx={{ borderRadius: "10%", overflow: "hidden", display:"block", alignItems:"center"}} item sm={1.5} md={1.5} lg={1.5}>
                    <Avatar sx={{ height: "3.5vh", width: "3.5vh", marginBottom: "2vh", marginTop: "1.5vh"}} alt={string.user} src={string.picture ? "https://manager-io-app.s3.amazonaws.com/" + string.picture : def_profile}/>
                </Grid>
